...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        sheet = pygame.image.load("./data/game/x.png")
        self.images = []
...
class EnemySprite(pygame.sprite.Sprite):
    def __init__(self, x_pos, groups):
        ...
        self.image = pygame.image.load("./data/game/enemy.png").convert_alpha()
        self.rect = self.image.get_rect()
        ...
        self.add(groups)
        self.explosion_sound = pygame.mixer.Sound("./data/game/Arcade Explo A.wav")
...
class ShipSprite(pygame.sprite.Sprite):
    def __init__(self, groups, weapon_groups):
        ...
        self.image = pygame.image.load("./data/game/ship.png").convert_alpha()
        self.rect = self.image.get_rect()
...
def main():
    ...
    # Get some music
    if pygame.mixer.get_init():
        pygame.mixer.music.load("./data/game/DST-AngryMod.mp3")
